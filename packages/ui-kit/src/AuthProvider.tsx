 ...
 * - Exposes a `logout()` that hits POST `/api/auth/logout` and clears local state.
 ...
 * keeps working. `roles` contains canonical role codes
 * (`admin` | `provider` | `verifier` | `sovereign` | …) returned by
 * `/api/auth/me`.
 */
