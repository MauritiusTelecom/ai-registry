    ...
    <div className="p-content">
      ...
      <section className="glass" style={{ padding: 20, borderRadius: 12, marginBottom: 18 }}>
        ...
        <p style={{ marginTop: 14, fontSize: 12.5, color: "var(--text-3)" }}>
          {evidenceCount} sovereignty-evidence row{evidenceCount === 1 ? "" : "s"} attached to
          local resources.
        </p>
      </section>
      ...
      <section className="glass" style={{ padding: 20, borderRadius: 12 }}>
        ...
        >
          Official authorities ({authorities.length})
        </h2>
            ...
            {authorities.map((a) => (
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
                  ...
                  >
                    {a._count.authorisations} authorisation
                    {a._count.authorisations === 1 ? "" : "s"}
                  </span>
                </div>
                {a.websiteUrl ? (
                  <Link
