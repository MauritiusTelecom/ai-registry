/**
 * Route shim. The page body lives in `@airegistry/public/pages/RegistryDetailPage` so the public site
 ...
 */
export { default, metadata, dynamic } from "@airegistry/public/pages/RegistryDetailPage";
