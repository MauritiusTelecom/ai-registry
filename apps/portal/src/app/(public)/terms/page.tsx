/**
 * Route shim. The page body lives in `@airegistry/public/pages/TermsPage` so the public site
 ...
 */
export { default, generateMetadata } from "@airegistry/public/pages/TermsPage";
