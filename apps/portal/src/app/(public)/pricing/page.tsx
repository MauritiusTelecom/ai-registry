/**
 * Route shim. The page body lives in `@airegistry/public/pages/PricingPage` so the public site
 ...
 */
export { default, generateMetadata } from "@airegistry/public/pages/PricingPage";
