/**
 * Route shim. The page body lives in `@airegistry/public/pages/AuditLogPage` so the public site
 ...
 */
export { default, generateMetadata } from "@airegistry/public/pages/AuditLogPage";
