/**
 * Route shim. The page body lives in `@airegistry/public/pages/LoginPage` so the public site
 ...
 */
export { default, generateMetadata } from "@airegistry/public/pages/LoginPage";
