...
export default async function SovereignIncidentsPage() {
  const t = await getTranslations("sovereign.incidents");
  const cfg = getConfig();
  ...
  const columns: Column<Row>[] = [
    ...
    { key: "by", label: t("columnBy"), render: (row) => row.performedBy, mono: true },
    { key: "at", label: t("columnWhen"), render: (row) => row.performedAt, mono: true }
  ];
